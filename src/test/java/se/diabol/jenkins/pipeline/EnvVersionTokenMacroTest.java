...
@WithJenkins
class EnvVersionTokenMacroTest {
    ...
    @Test
    void testNoParseVersionExists() throws Exception {
    ...
    @Test
    void testParseVersionExists() throws Exception {
        EnvVersionTokenMacro macro = new EnvVersionTokenMacro();
    ...
    @Test
    void testParseWithStripedVersionExists() throws Exception {
        EnvVersionTokenMacro macro = new EnvVersionTokenMacro();
